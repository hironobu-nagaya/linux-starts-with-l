...
みどり（驚き）：
  ...
  そういうふうに書くんだね！
しげる（通常）：
  また、何も書かれていない「空行」も読みやすさに影響するよ
  何も実行しないけど必要があれば空行も入れてみよう
...
しげる（笑顔）：
  丁寧な説明だね！
しげる（通常）：
  細かく書き過ぎと思われるかもしれないけど別にいいんだよ
  自分のレベルに合わせた内容でコメントを書いていこう！
みどり（笑顔）：
  えへへ！
  ほめられると照れるなぁ…
...
しげる（通常）：
  `#` をクォート(ダブルクォート含む)すればコメントの意味を失わさせれるよ
  必要があればクォートしよう！
