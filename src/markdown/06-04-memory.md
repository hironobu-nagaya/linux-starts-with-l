...
しげる（通常）：
  ...
  数値に接尾辞(`K`, `M`, `G` など)を付けて短い値を表示をするよ
...
しげる（通常）：
  メモリに空きがあると効率を上げるために
  バッファやキャッシュとして積極的に使われるんだ
  メモリに余裕があっても
  used と total が近いことはよくあるよ
  メモリの空きに余裕があるかどうかは
  available が十分あるかどうかで判断すると良いよ
